...
// Dummy user (replace with actual user/auth logic)
    ...
    const links = <>
   <ul>
     <li className='font-bold md:text-xl text-md'>< NavLink to= '/'>Home</NavLink></li>
   </ul>
   <ul>
    <li className='font-bold md:text-xl text-md'><NavLink to= '/AvailableCamps'>Available-camps</NavLink></li>
   </ul>
     </>
