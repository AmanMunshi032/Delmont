      ...
      <div className="max-w-7xl mx-auto px-4  shadow-md rounded-2xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {camps.map((camp) => (
            <div
              key={camp._id}
              className="bg-white  flex flex-col justify-between shadow-md rounded-xl overflow-hidden hover:shadow-lg transition"
            >
              <img
                src={camp.image}
                alt={camp.name}
        ...
        <div className="text-center mt-10 ">
          <Link to="/AvailableCamps">
            <button className="bg-cyan-300 mb-5 px-6 py-2 rounded-full hover:bg-cyan-300 transition">
              See All Camps
            </button>
          </Link>
        </div>
